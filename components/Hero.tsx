  ...
  return (
    <div>
        <div className="grid grid-cols-12 gap-4 grid-rows-8">
          ...
          <div className=" col-start-4 row-start-2 col-span-6 row-span-4 bg-yellow-500  ">
            ...
            <div className=" h-fit text-center font-federo text-89 leading-none tracking--1 z-10">
          ...
          <div className="row-span-1 col-start-10 row-start-7 col-span-3 bg-yellow-500 mr-16  h-4/5 hover:border-b-4 hover:border-l-4 border-green-500">
            <div className="flex">
              <Image src={photo} alt="photo" />
          ...
          <div className="row-span-1 col-start-2 row-start-5 col-span-2 bg-red-500 mr-8  h-4/5 hover:border-b-4 hover:border-l-4 border-green-500">
            <div className="flex">
              <Image src={photo} alt="photo" />
